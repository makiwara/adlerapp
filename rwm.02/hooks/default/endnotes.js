...
], function(constants, Core, Hooks) {
    Hooks.register('beforeChapterDisplay').endnotes = function(callback,
        chapter) {
      ...
      Core.addCss(constants.CSS_PATH + 'layout.css', false, chapter.doc.head);
